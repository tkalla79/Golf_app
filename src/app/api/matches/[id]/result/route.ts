...
export async function POST(
  ...
  const { winnerId, resultCode, isWalkover, holes, player1Birdies, player2Birdies } = body
  ...
  const updated = await prisma.match.update({
    ...
    data: {
      ...
      isWalkover: !!isWalkover,
      played: true,
      holes: holes !== undefined && holes !== null ? parseInt(String(holes), 10) : undefined,
      player1Birdies: player1Birdies !== undefined ? parseInt(String(player1Birdies), 10) || 0 : undefined,
      player2Birdies: player2Birdies !== undefined ? parseInt(String(player2Birdies), 10) || 0 : undefined,
      ...points,
    },
