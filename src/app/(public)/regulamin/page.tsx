...
export default function RegulaminPage() {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="card p-6 sm:p-10 prose prose-slate max-w-none prose-headings:font-bold prose-h2:text-[var(--color-primary)] prose-h2:border-b-2 prose-h2:border-[var(--color-accent)] prose-h2:pb-2 prose-h3:text-[var(--color-text-dark)] prose-h4:text-[var(--color-primary)] prose-a:text-[var(--color-primary)] prose-strong:text-[var(--color-text-dark)] prose-table:text-sm">

        {/* I. Postanowienia ogólne */}
        <section>
          <h2 className="not-prose text-xl font-bold text-[var(--color-primary)] border-b-2 border-[var(--color-accent)] pb-2 mb-5">I. Postanowienia ogólne</h2>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">1. Miejsce i forma rozgrywek</h3>
          ...
          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">2. Obowiązki finansowe</h3>
          <ul className="list-disc">
        ...
        <section>
          <h2 className="not-prose text-xl font-bold text-[var(--color-primary)] border-b-2 border-[var(--color-accent)] pb-2 mb-5">II. Struktura turnieju</h2>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">1. Etapy rozgrywek</h3>
          <div className="overflow-x-auto">
            <table className="not-prose standings-table w-full text-sm">
              <thead>
                <tr>
                  <th>Etap</th>
                  <th>Termin</th>
          ...
          <p className="text-sm text-[var(--color-text-body)]/60 mt-2 italic">
            Zalecane jednoczesne rozegranie meczów o miejsca 1–4.
          </p>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">2. Podział grup</h3>
          <ul className="list-disc">
        ...
        {/* III. Zasady gry */}
        <section>
          <h2 className="not-prose text-xl font-bold text-[var(--color-primary)] border-b-2 border-[var(--color-accent)] pb-2 mb-5">III. Zasady gry i zgłaszania wyników</h2>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">1. System rozgrywek</h3>
          <p>W grupach obowiązuje system <strong>„każdy z każdym"</strong>.</p>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">2. Punktacja</h3>
          <div className="overflow-x-auto">
            <table className="not-prose standings-table w-full text-sm">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr><td>Remis</td><td className="text-center font-bold text-[var(--color-accent)]">2 pkt (każdy)</td></tr>
                <tr><td>Porażka</td><td className="text-center font-bold">1 pkt</td></tr>
                <tr><td>Nierozegrany mecz</td><td className="text-center text-[var(--color-text-body)]/50">0 pkt (obaj)</td></tr>
                <tr><td>Walkower</td><td className="text-center">Wygrany: <strong>3 pkt</strong>, przegrany: <strong>0 pkt</strong></td></tr>
              </tbody>
            </table>
          </div>
          <p className="mt-3">W fazie grupowej dodatkowo przyznawane <strong>„małe punkty"</strong> (patrz niżej).</p>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">3. Zgłaszanie wyników</h3>
          <ul className="list-disc">
          ...
          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">4. Rozstrzyganie remisów w grupach</h3>
          ...
          <div className="overflow-x-auto">
            <table className="not-prose standings-table w-full text-sm">
              ...
              <tbody>
                ...
                <tr><td>1Up</td><td className="text-center text-[var(--color-success)]">+1</td><td className="text-center text-[var(--color-danger)]">−1</td></tr>
                <tr><td>2Up</td><td className="text-center text-[var(--color-success)]">+2</td><td className="text-center text-[var(--color-danger)]">−2</td></tr>
                <tr><td>2&amp;1</td><td className="text-center text-[var(--color-success)]">+3</td><td className="text-center text-[var(--color-danger)]">−3</td></tr>
                <tr><td>3&amp;1</td><td className="text-center text-[var(--color-success)]">+4</td><td className="text-center text-[var(--color-danger)]">−4</td></tr>
                <tr><td>3&amp;2</td><td className="text-center text-[var(--color-success)]">+5</td><td className="text-center text-[var(--color-danger)]">−5</td></tr>
                <tr><td>4&amp;2</td><td className="text-center text-[var(--color-success)]">+6</td><td className="text-center text-[var(--color-danger)]">−6</td></tr>
                <tr><td>4&amp;3</td><td className="text-center text-[var(--color-success)]">+7</td><td className="text-center text-[var(--color-danger)]">−7</td></tr>
                <tr><td>5&amp;3</td><td className="text-center text-[var(--color-success)]">+8</td><td className="text-center text-[var(--color-danger)]">−8</td></tr>
                <tr><td>5&amp;4</td><td className="text-center text-[var(--color-success)]">+9</td><td className="text-center text-[var(--color-danger)]">−9</td></tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-[var(--color-text-body)]/60 mt-2 italic">
        ...
        {/* IV. Faza PLAY-OFF */}
        <section>
          <h2 className="not-prose text-xl font-bold text-[var(--color-primary)] border-b-2 border-[var(--color-accent)] pb-2 mb-5">IV. Faza PLAY-OFF</h2>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">1. Drabinki</h3>
          ...
          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">2. Terminy meczów play-off</h3>
          <div className="overflow-x-auto">
            <table className="not-prose standings-table w-full text-sm">
              <thead>
                <tr>
          ...
          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">3. Dogrywka</h3>
          <p>Remisy w PLAY-OFF rozstrzygane są w formacie <strong>„nagłej śmierci"</strong> od dołka nr 1.</p>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">4. Nierozegrane mecze fazy play-off</h3>
        ...
        {/* V. Nagrody */}
        <section>
          <h2 className="not-prose text-xl font-bold text-[var(--color-primary)] border-b-2 border-[var(--color-accent)] pb-2 mb-5">V. Nagrody i klasyfikacja</h2>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">1. Nagrody pieniężne</h3>
          ...
          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">2. Wpływ na kolejne sezony</h3>
          <p>Rozstawienie w Lidze 2027 ustalane będzie na podstawie końcowej klasyfikacji 2026.</p>
        </section>

        {/* VI. Postanowienia końcowe */}
        <section>
          <h2 className="not-prose text-xl font-bold text-[var(--color-primary)] border-b-2 border-[var(--color-accent)] pb-2 mb-5">VI. Postanowienia końcowe</h2>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">1. Interpretacja regulaminu</h3>
          <p>Wszelkie spory oraz kwestie nieujęte w regulaminie rozstrzyga Zarząd Ligi.</p>

          <h3 className="text-lg font-bold text-[var(--color-text-dark)]">2. Komunikacja</h3>
