      ...
      <div style="font-family: 'Lato', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 30px;">
        ...
        <div style="background: #f8f6f1; border: 1px solid #e8e2d4; border-radius: 8px; padding: 20px; margin: 20px 0;">
          <table style="width: 100%; font-size: 14px; color: #555;">
            ...
            <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">${isPlayoff ? 'Liga' : 'Grupa'}:</td><td style="padding: 4px 0;">${groupName}</td></tr>
    ...
    html: `
      <div style="font-family: 'Lato', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 30px;">
        ...
        <div style="background: #f8f6f1; border: 1px solid #e8e2d4; border-radius: 8px; padding: 20px; margin: 20px 0;">
          <table style="width: 100%; font-size: 14px; color: #555;">
            <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Przeciwnik:</td><td style="padding: 4px 0;">${opponentName}</td></tr>
            <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">${groupLabel}:</td><td style="padding: 4px 0;">${groupName}</td></tr>
            <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Runda:</td><td style="padding: 4px 0;">${roundName}</td></tr>
            <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Termin:</td><td style="padding: 4px 0;"><strong style="color: #134a56;">${matchDate}</strong></td></tr>
          </table>
        </div>
      ...
      await transporter.sendMail({
        ...
        html: `
          <div style="font-family: 'Lato', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 30px;">
            ...
            <div style="background: #f8f6f1; border: 1px solid #e8e2d4; border-radius: 8px; padding: 20px; margin: 20px 0;">
              <table style="width: 100%; font-size: 14px; color: #555;">
                <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Mecz:</td><td style="padding: 4px 0;">${player1Name} vs ${player2Name}</td></tr>
                <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Grupa:</td><td style="padding: 4px 0;">${groupName}</td></tr>
                <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Runda:</td><td style="padding: 4px 0;">${roundName}</td></tr>
                <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Tee time:</td><td style="padding: 4px 0;"><strong style="color: #134a56;">${teeTime}</strong></td></tr>
              </table>
            </div>
            <p style="color: #555; font-size: 14px;">Godzina rozpoczęcia to start z tee box. Powodzenia! ⛳</p>
            <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;" />
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: 'Lato', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 30px;">
          ...
          <div style="background: #f8f6f1; border: 1px solid #e8e2d4; border-radius: 8px; padding: 20px; margin: 20px 0;">
            <table style="width: 100%; font-size: 14px; color: #555;">
              <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Gracze:</td><td style="padding: 4px 0;">${player1Name}, ${player2Name}</td></tr>
              <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Liga:</td><td style="padding: 4px 0;">${groupName} - ${roundName}</td></tr>
              <tr><td style="padding: 4px 0; font-weight: 700; color: #134a56;">Tee time:</td><td style="padding: 4px 0;"><strong style="color: #134a56;">${teeTime}</strong></td></tr>
            </table>
          </div>
          <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;" />
